...
<script>
    ...
    function move(ev){
        if(ev.type != 'contextmenu'){
            ...
            layer.style.cssText = 'transform: translate(' + Math.round(curLeft) + 'px,' + Math.round(curTop) + 'px)'
        }
    }
    ...
    function getLayerPosition(vm){
        vue.nextTick(function(){
            ...
            layer.style.cssText = 'transform: translate(' + Math.round(x) + 'px,' + Math.round(y) + 'px)'
        })
    }
